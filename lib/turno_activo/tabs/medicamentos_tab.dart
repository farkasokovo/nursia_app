...
class MedicamentosTab extends StatelessWidget {
  final List<MedicamentoTurno> items;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Lleva el control de los fármacos administrados durante este turno.",
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  backgroundColor: estaSeleccionado
                      ...
                      : colorScheme.primaryContainer,
                  child: Icon(
                    IconMapper.fromString(item.icono),
                    size: 18,
                    color: estaSeleccionado
                        ? colorScheme.error
